...
class firstfragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        Toast.makeText(requireContext(), "CreateView", Toast.LENGTH_SHORT).show()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Toast.makeText(requireContext(), "viewCreated", Toast.LENGTH_SHORT).show()
    }
